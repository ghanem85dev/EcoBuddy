...
import { AiOutlineEdit, AiOutlineDelete, AiOutlineFilePdf } from "react-icons/ai";
...
const SitesSettings = () => {
  ...
  const [newResidence, setNewResidence] = useState({ nom: '', adresse: '', latitude: 0, longtitude: 0, certificat_propriete: null });
  ...
  const handleModify = (residence) => {
    ...
    setNewResidence({
      ...
      longtitude: residence.longtitude,
  ...
  const handleAddOrUpdateResidence = async () => {
    ...
    try {
      ...
      formData.append("longtitude", newResidence.longtitude);
      ...
      setNewResidence({ nom: '', adresse: '', latitude: 0, longtitude: 0, certificat_propriete: null });
