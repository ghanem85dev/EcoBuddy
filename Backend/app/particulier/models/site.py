from sqlalchemy import Column, String, Integer, ForeignKey, JSON, Float, LargeBinary
from sqlalchemy.orm import relationship
from pydantic import BaseModel
from app.commun.models import Base
...
class Site(Base):
    ...
    certificat_propriete = Column(LargeBinary, nullable=True)  # Binary data for the PDF file
    certificat_propriete_nom = Column(String, nullable=True)  # File name of the PDF
